      ...
      <div className="h-16 border-b border-white/5 bg-[#0B0D1E] flex items-center px-6 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">
            ...
            <span className="text-gray-500 text-base ml-2">by 木羽cheney</span>
          </h1>
        </div>
        <div className="ml-auto flex items-center gap-4">
          ...
          <button className="px-5 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 transition-all shadow-lg shadow-cyan-500/20 text-white font-medium text-sm">
            点击获取课程优惠
          </button>
        </div>
      </div>
